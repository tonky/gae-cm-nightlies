...
device_specific = {
    ...
    "maguro": ["android_device_samsung_maguro"],
    ...
    "smultron": ["android_device_semc_smultron", "android_device_semc_mogami-common", 
               "android_device_semc_msm7x30-common"],
    "stingray": ["android_device_moto_stingray", "android_device_moto_common"],
    ...
    "wingray": ["android_device_moto_wingray", "android_device_moto_common"],
